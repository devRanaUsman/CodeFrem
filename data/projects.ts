...
export const projects: Project[] = [
  {
    ...
    process: [
      ...
      },
      {
        ...
        title: "Design",
        description:
          "Token-driven design system first, then high-fidelity screens — every new feature inherits the language for free.",
      },
      {
        step: "04",
        title: "Test",
  ...
  },
  {
    ...
    process: [
      ...
      },
      {
        ...
        title: "Deliver",
        description:
          "Brand book, Figma library and coded components — market thirteen ships as configuration, not a new project.",
      },
    ],
    results: [
      {
