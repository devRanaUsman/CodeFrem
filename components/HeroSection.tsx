...
export default function HeroSection() {
  return (
    <section
      id="hero-section"
      className="w-full min-h-screen lg:h-screen lg:max-h-[960px] bg-white text-[#111111] rounded-b-[40px] sm:rounded-b-[56px] px-4 sm:px-8 lg:px-12 flex flex-col justify-between pt-16 sm:pt-20 pb-8 relative shadow-2xl overflow-hidden"
    >
      {/* Decorative Lime Starburst Flower on Left */}
      <div className="absolute top-24 left-6 sm:left-10 lg:left-16 text-[#AAFF00] pointer-events-none select-none">
        <svg
      ...
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center my-auto relative z-10">
        {/* 1. Main Heading (Slid down gracefully with generous breathing room below navbar) */}
        <div className="text-center max-w-4xl mx-auto relative z-20 mt-6 sm:mt-10 mb-2">
        ...
        {/* 2. Middle Grid: Left Text + Center Robot with Frosted Glass Buttons Overlapping + Right Stats */}
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-4 relative my-auto">
          ...
          {/* Center Column: 🤖 Robot with Frosted Glass Buttons on the lower sphere body */}
          <div className="lg:col-span-6 flex flex-col items-center justify-center relative order-1 lg:order-2 z-10 my-auto">
            ...
            {/* The 3D Robot Canvas */}
            <div className="relative z-10 w-full max-w-[520px] h-[430px] sm:h-[370px] flex items-center justify-center">
              <SplineRobot />
            </div>

            {/* Frosted Glass Buttons Capsule moved UP directly over the robot sphere matching reference image */}
            {/* Frosted Glass Buttons Capsule */}
            <div className="relative z-30 -mt-36 sm:-mt-42 flex justify-center">
              <div className="inline-flex items-center gap-1 p-1 rounded-full bg-black/45 backdrop-blur-2xl border border-white/25 shadow-2xl">
                <a
                  href="#contact"
                  className="px-4 sm:px-5 py-2 rounded-full bg-[#AAFF00] hover:bg-[#88CC00] text-black font-bold text-[11px] sm:text-xs transition-all shadow-[0_0_20px_rgba(170,255,0,0.35)] hover:scale-105 flex items-center gap-1"
                >
                ...
                <a
                  href="#services"
                  className="px-4 sm:px-5 py-2 rounded-full text-white hover:text-[#AAFF00] font-medium text-[11px] sm:text-xs border border-white/20 hover:border-white/40 bg-white/10 backdrop-blur-md transition-all"
                >
                  Let&apos;s Collaborate
                </a>
              </div>
