...
export default function MasterpiecesSection() {
  return (
    <section id="about" className="w-full py-20 lg:py-28 px-4 sm:px-6 lg:px-12 bg-[#0A0A0A] text-white">
      <div className="max-w-7xl mx-auto">
        {/* Header with Title and Description */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-14">
          <div className="lg:col-span-6 space-y-4">
            <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#AAFF00]">
              <Sparkles className="w-4 h-4" />
              <span>Who We Are</span>
            </div>
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif italic text-white tracking-tight leading-tight">
              Turning Ideas Into <br />
              <span className="not-italic text-white">Masterpieces</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="md:col-span-7 relative group rounded-3xl overflow-hidden border border-[#222222] bg-[#141414] min-h-[360px] md:min-h-[440px] flex items-end p-6 sm:p-8">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-30 group-hover:opacity-40 transition-opacity">
              <div className="w-full h-full bg-gradient-to-br from-zinc-800 to-black flex items-center justify-center">
                <span className="text-8xl font-black text-white/5 select-none">Codefrem</span>
              </div>
            </div>

            {/* Bottom Content & Tag */}
            <div className="relative z-20 w-full space-y-3">
              <div className="inline-block bg-[#AAFF00] text-black font-extrabold text-xs sm:text-sm px-4 py-1.5 rounded-sm tracking-wider uppercase shadow-[0_0_20px_rgba(170,255,0,0.3)]">
          ...
          {/* Right Showcase Card */}
          <div className="md:col-span-5 relative rounded-3xl overflow-hidden border border-[#222222] bg-[#141414] min-h-[360px] md:min-h-[440px] flex flex-col justify-between p-6 sm:p-8">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-[#1a1a1a] border border-[#333333] flex items-center justify-center text-[#AAFF00]">
                ✦
              </div>
            ...
            <div className="pt-6 border-t border-[#222222] flex items-center justify-between">
              ...
              <span className="text-xs text-[#AAFF00] font-mono font-medium">
                0ms Latency
              </span>
            </div>
          </div>
